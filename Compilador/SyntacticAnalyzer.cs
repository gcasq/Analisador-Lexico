...
namespace LexicAnalyzer {
    public class SyntacticAnalyzer {
        public SemanticAnalyzer Semantics { get; set; } = new();
        public void syntacticAnalizer() {
            string actionPath = "C:\\Users\\gusta\\OneDrive\\Área de Trabalho\\IME\\Compiladores\\Compilador\\Compilador\\action_table.csv";
            string lenLeftPath = "C:\\Users\\gusta\\OneDrive\\Área de Trabalho\\IME\\Compiladores\\Compilador\\Compilador\\len_left_table.csv";
            ...
            do {
                ...
                if (IsShift(p)) {
                    ...
                    Semantics.semantics(r, tokenSecundario, 0);
                } else {
                    SyntaxError();
                }
                q = stateStack.Peek();
